...
const checkUserExistence = async (userId) => {
    ...
    const responsePromise = new Promise((resolve) => {
        pendingUserRequests.set(correlationId, (result) => {
            console.log("✅ Réponse reçue pour checkUserExistence:", result);
            resolve(result);
        });
    });
    ...
    console.log("📤 Demande envoyée (user-existence-check):", payload);
